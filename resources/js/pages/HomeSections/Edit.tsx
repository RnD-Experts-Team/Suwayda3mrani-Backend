// resources/js/pages/HomeSections/Edit.tsx
...
export default function HomeSectionEdit({ homeSection, translations }: Props) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        _method: 'PUT',
        type: homeSection.type as 'hero' | 'suggestion',
        ...
        button_text_en: translations.button_text_en || '',
        button_text_ar: translations.button_text_ar || '',
        button_variant: homeSection.button_variant || '',
        action_key: homeSection.action_key || '',
    ...
    useEffect(() => {
        ...
        if (homeSection.image_path) {
            setImagePreview(`/storage/${homeSection.image_path}`);
        }
    }, [homeSection]);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/home-sections/${homeSection.id}`);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit - ${translations.title_en || 'Home Section'}`} />
            
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 overflow-x-auto">
                <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
                    <div className="space-y-1">
                        <h1 className="text-2xl font-bold tracking-tight">Edit Home Section</h1>
                        <p className="text-sm text-muted-foreground">
                            Update section details and content
                        </p>
                    </div>
                    <div className="flex gap-2">
                        <Badge variant="outline">{homeSection.section_id}</Badge>
                        <Badge variant="outline" className="capitalize gap-1">
                            {homeSection.type === 'hero' ? <Home className="w-3 h-3" /> : <Layout className="w-3 h-3" />}
                            {homeSection.type}
                        </Badge>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl">
                        ...
                        <Card className="overflow-hidden">
                            ...
                            <CardContent className="p-6">
                                <form onSubmit={handleSubmit} className="space-y-6">
                                            ...
                                            <div className="border rounded-lg p-4 bg-muted/30">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="flex-1">
                                                        <p className="text-sm font-medium">Current section image</p>
                                    ...
                                    <div className="space-y-3">
                                        <Label>
                                            {homeSection.image_path ? 'Replace Image' : 'Section Image'} (Optional)
                                        </Label>
                                        <div className="border-2 border-dashed border-border rounded-lg p-6">
                                            <div className="text-center space-y-4">
                                                ...
                                                >
                                                    ...
                                                    {homeSection.image_path ? 'Replace Image' : 'Choose Image'}
                                                </Label>
                                            </div>
                                        </div>
                                        {errors.image && (
                    ...
                    <div className="space-y-4">
                        ...
                        <Card>
                            <CardHeader className="px-6 py-4 border-b">
                                <CardTitle className="text-lg font-semibold">Section Info</CardTitle>
                            </CardHeader>
                            <CardContent className="p-6">
                                <div className="space-y-3 text-sm">
                                    <div className="flex justify-between">
                                        <span className="text-muted-foreground">ID:</span>
                                        <span className="font-mono">{homeSection.section_id}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-muted-foreground">Created:</span>
                                        <span>{new Date(homeSection.created_at).toLocaleDateString()}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-muted-foreground">Updated:</span>
                                        <span>{new Date(homeSection.updated_at).toLocaleDateString()}</span>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
