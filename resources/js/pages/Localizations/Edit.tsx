// resources/js/pages/Localizations/Edit.tsx
...
export default function EditLocalization({ localization, languages = null, groups = null }: Props) {
    ...
    const { data, setData, processing, errors } = useForm({
        ...
        group: localization.group || '__none__',
        key: localization.key,
        value: localization.value,
        description: localization.description || '',
        is_active: localization.is_active,
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const finalData = {
            language: useCustomLanguage ? customLanguage.trim() : data.language,
        ...
        router.put(`/localizations/${localization.id}`, finalData, {
            onSuccess: () => {
                console.log('Localization updated successfully');
            },
            onError: (errors) => {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Localization - ${localization.key}`} />
            
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 overflow-x-auto">
                <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
                    <div className="space-y-1">
                        <h1 className="text-2xl font-bold tracking-tight">Edit Localization</h1>
                        <p className="text-sm text-muted-foreground">Update the translation entry details</p>
                    </div>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end gap-2">
                                ...
                                <Button type="submit" disabled={processing} size="sm" className="gap-2">
                                    {processing ? 'Updating...' : 'Update Localization'}
                                </Button>
                            </div>
                        </form>
                    </CardContent>
