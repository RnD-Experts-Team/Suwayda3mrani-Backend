// resources/js/pages/AidOrganizations/Create.tsx
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/aid-organizations/create' },
];

export default function AidOrganizationCreate({ categories }: Props) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        website_url: '',
        contact_url: '',
        type: 'organizations' as 'organizations' | 'initiatives',
        is_featured: false,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/aid-organizations');
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Aid Organization" />
            
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 overflow-x-auto">
                <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
                    <div className="space-y-1">
                        <h1 className="text-2xl font-bold tracking-tight">Create New Aid Organization</h1>
                        <p className="text-sm text-muted-foreground">Add a new organization or initiative</p>
                    </div>
                </div>
